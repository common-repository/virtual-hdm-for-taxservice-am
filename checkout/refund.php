            ...
            <div class="row mb-5"
                ...
                <div class="mt-4 col-xl-6 col-lg-6 col-md-6 col-sm-12"
                    ...
                    <div style="box-sizing: border-box;">ՀՎՀՀ՝ <strong
                                style="box-sizing: border-box;font-weight: bolder;"><?php echo  esc_html($taxServiceTin) ?></strong></div>
                    ...
                    <table class="table table-striped"
                        ...
                        <?php foreach ($items as $item):
                            ...
                            <tr style="box-sizing: border-box;page-break-inside: avoid;">
                                ...
                                <td class="left strong" style="box-sizing: border-box;"><?php echo  esc_html($itemAtgCode )?></td>
                                <td class="left" style="box-sizing: border-box;"><?php echo  esc_html($validationCode) ?></td>
                                <td class="right" style="box-sizing: border-box;"><?php echo  esc_html($item->get_name()) ?></td>
                                <td class="center" style="box-sizing: border-box;"><?php echo  esc_html($item->get_quantity()) ?></td>
                                <td class="center" style="box-sizing: border-box;"><?php echo  esc_html($itemUnit) ?></td>
                                <td class="center"
                                    style="box-sizing: border-box;"><?php echo esc_html($product->get_regular_price()) ?></td>
                                <?php if($isSale):?>
                                    <td class="right" style="box-sizing: border-box;"><?php if ($product->is_on_sale()) {
                                            $isSale = true;
                                            $salePrice += ((float)$product->get_regular_price() - (float)$product->get_sale_price());
                                            echo $product->get_regular_price() - $product->get_sale_price(). ' դրամ';
                                        } else {
                                ...
                                <?php endif;?>
                                <td class="center" style="box-sizing: border-box;"><?php echo  esc_html($item->get_total()) ?></td>
                            </tr>
                        <?php endforeach; ?>
